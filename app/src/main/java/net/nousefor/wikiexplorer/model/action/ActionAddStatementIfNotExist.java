...
public class ActionAddStatementIfNotExist extends ActionAddStatement {
    ...
    public boolean execute(String parmsJson, Context context) throws Exception {
        ...
        ActionAddStatement.Parms p = new Gson().fromJson(parmsJson, ActionAddStatement.Parms.class);
