...
public class ActionAddDescription extends Action {

    public String language;

    public ActionAddDescription() {
        labels = new HashMap<String, String>() {{
            put("en", "Add description");
        }};
    }

    RemoteInput getRemoteInput(Context context) {
        String label = context.getString(R.string.ui_notification_add_description_en);
    ...
    public boolean execute(String parmsJson, Context context) throws Exception {
        ...
        if (!w.setDescription(p.itemId, p.language, getRemoteInputValue()))
