...
public class ActionAddDescriptionIfNotExists extends ActionAddDescription {
    ...
    public NotificationCompat.Action createAction(ItemNotification itemNotification, Context context) {
        if (wikidata.getDescription(itemNotification.itemId, language) != null)
            return null;
    ...
    public boolean execute(String parmsJson, Context context) throws Exception {
        ...
        if (wikidata.getDescription(p.itemId, p.language) != null)
