...
public class NotificationPreferencesActivity extends AppCompatActivity {
    ...
    public static class Fragment extends PreferenceFragmentCompat {
        ...
        private void initEnableEditSwitch() {
            final SwitchPreferenceCompat sw = findPreference(getString(R.string.preferences_notifications_enable_edit));
        ...
        private void initMemoryClearButton() {
            Preference button = findPreference(getString(R.string.preferences_notifications_memory_clear));
        ...
        private void initAboutButton() {
            Preference button = findPreference(getString(R.string.preferences_about));
            button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    TextView msg = new TextView(getContext());
                    msg.setText(Html.fromHtml(getString(R.string.preferences_about_text)));
                    msg.setMovementMethod(LinkMovementMethod.getInstance());
