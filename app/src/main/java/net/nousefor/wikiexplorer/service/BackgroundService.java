...
public class BackgroundService extends Service {
    ...
    public void updatePreferences() {
        ...
        locationUpdateInterval = sharedPreferences.getInt(getString(R.string.preferences_notifications_location_update_interval), locationUpdateInterval);
        maximumNotifications = sharedPreferences.getInt(getString(R.string.preferences_notifications_amount_max), maximumNotifications);

        enableUniqueMode = sharedPreferences.getBoolean(getString(R.string.preferences_notifications_unique), enableUniqueMode);
        enableEditing = sharedPreferences.getBoolean(getString(R.string.preferences_notifications_enable_edit), enableEditing);
        enableWikipediaSummary = sharedPreferences.getBoolean(getString(R.string.preferences_notifications_wikipedia_summary), enableWikipediaSummary);
    }
